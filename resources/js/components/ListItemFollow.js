...
export default class ListItemFollow extends Component {
    ...
    setFollow(){
        if(this.props.obj.follow == ''){
            this.props.obj.follow = 0;

            return 'fddsf'
        }else{
            return this.props.obj.follow
        }
    }
            ...
            <div className="col-md-4 " >
                <Link className="LinkWithId" to={"/project/" + this.props.obj.id}>
                    ...
                    <div className="componentItem">
                        ...
                        <i class="fas fa-grin-squint-tears"></i>&nbsp; {this.props.obj.follow} <br />
